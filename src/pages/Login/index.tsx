...
export function Login() {
  ...
  return (
    <div className='flex justify-center min-h-full py-4 sm:bg-background sm:py-16'>
      <div className='h-fit w-full bg-white rounded-lg p-8 flex gap-4 sm:w-3/5'>
        <div className='flex flex-col gap-4 flex-1'>
          <div>
            <h4 className='text-xl font-bold text-black'>Bem vindo!</h4>
            <p className='text-base'>Faça login para utilizar nossos serviços</p>
          </div>

          <div className='pb-2'>
            <p className='mb-2'>Fazer login com:</p>
            <Button icon={<AiOutlineGoogle className='h-5 w-5' />} fullWidth />
          </div>
            ...
            <form className='flex flex-col gap-2'>
              ...
              <label className='form-control w-full'>
                ...
                <input
                  type='password'
                  placeholder='Senha'
                  className='input input-bordered input-sm w-full max-w-xs bg-white text-base focus:border-transparent'
                />
              </label>
          ...
          <p>
            Ainda não tem uma conta? <Link to='/sign-up'>Criar conta</Link>
          </p>
        </div>

        <img className='hidden w-1/3 rounded-lg lg:block' src={banner} alt='image description' />
      </div>
    </div>
  );
}
